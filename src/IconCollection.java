...
public class IconCollection {
	...
	public final ImageIcon bigMine = new ImageIcon("pic/bigMine.png");
	public final ImageIcon mute = new ImageIcon("pic/mute.png");
	public final ImageIcon volume = new ImageIcon("pic/volume.png");
